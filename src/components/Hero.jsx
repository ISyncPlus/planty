    ...
    <div className="mt-15 w-screen">
        ...
        <section className="flex justify-between">
            <div className="max-h-dvh w-[55%]">
                <h1 className="font-belleza text-[30px] md:text-[55px] lg:text-[80px] md:font-[500] pt-15 z-10 text-wrap w-50 md:w-90 lg:w-140 md:leading-20">Best house plants varieties</h1>
                ...
                <section className="flex flex-col-reverse md:flex-col">
                    ...
                    <article className="flex flex-col gap-5 md:gap-10 mt-9 md:mt-15">
                        ...
                        <p className="font-[500] font-quicksand text-sm md:text-2xl lg:text-3xl w-45 md:w-90 lg:w-100 md:pl-3">
                ...
                <div className="flex gap-5 md:gap-0  md:justify-between items-center mt-10 md:mt-17 text-gray-500 w-47 md:w-75 lg:w-100 font-bold text-[16px] md:text-3xl lg:text-4xl">
